...
const ushort16 MAX_COUNT_RELEASED_CONTENT_CELLS = MAX_SHORT - (MAX_CHAR - ONLY_CONTENT_TYPE);
const ushort16 MAX_COUNT_RELEASED_BRANCH_CELLS = MAX_SHORT - (MAX_CHAR - ONLY_CONTENT_TYPE);
const ushort16 MAX_COUNT_RELEASED_BLOCK_CELLS = MAX_SHORT - (MAX_CHAR - ONLY_CONTENT_TYPE);
const ushort16 MAX_COUNT_RELEASED_VAR_CELLS = MAX_SHORT - (MAX_CHAR - ONLY_CONTENT_TYPE);
