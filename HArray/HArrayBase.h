...
const ushort16 MAX_COUNT_RELEASED_CONTENT_CELLS = MAX_SHORT * 2; //two pages
const ushort16 MAX_COUNT_RELEASED_BRANCH_CELLS = MAX_SHORT;
const ushort16 MAX_COUNT_RELEASED_BLOCK_CELLS = MAX_SHORT;
const ushort16 MAX_COUNT_RELEASED_VAR_CELLS = MAX_SHORT;
